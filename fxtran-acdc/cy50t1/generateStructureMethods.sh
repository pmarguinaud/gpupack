...
arpifs/module/yoeradiation.F90 \
...
arpifs/module/yoeaerc_tegen.F90 \
arpifs/module/yoeaerraddesc.F90 \
arpifs/module/drydep_par.F90 \
arpifs/module/yomtendra.F90 \
arpifs/module/model_physics_scm_mod.F90 \
arpifs/module/model_physics_forcing_mod.F90
do
  set -x
  generateStructureMethods.pl \
