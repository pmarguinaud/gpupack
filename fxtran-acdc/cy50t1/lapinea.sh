...
do
  ...
  pointerParallel.pl \
    ...
    --cycle 50 --use-acpy --types-fieldapi-dir types-fieldapi --post-parallel synchost,nullify \
...
do
  dir=$(dirname $f)
  openacc.pl --interface --dummy --stack84 --cycle 50 --pointers --nocompute ABOR1 --version --cpg_dyn --dir src/local/ifsaux/openacc/$dir $(resolve --user $f)
done
