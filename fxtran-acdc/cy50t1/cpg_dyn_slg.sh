...
pointerParallel.pl \
  --gpumemstat --stack84 --jlon JROF --nproma YDCPG_OPTS%KLON,YDGEOMETRY%YRDIM%NPROMA,YDGEOMETRY%YRDIM%NPROMNH --cycle 50 --use-acpy \
...
dir=$(dirname $f)
openacc.pl --interface --stack84 --cycle 50 --pointers --nocompute ABOR1 --version --cpg_dyn --dir src/local/ifsaux/openacc/$dir $(resolve --user $f)
...
openacc.pl --interface --stack84 --cycle 50 --pointers --nocompute ABOR1 --version --dir src/local/ifsaux/openacc/$dir $(resolve --user $f)
...
do
  ...
  openacc.pl \
    ...
    --stack84 --cycle 50 --pointers --nocompute ABOR1 --version --cpg_dyn --dir src/local/ifsaux/openacc/$dir $(resolve --user $f)
done
